...
export const PLANS = [
	...
	},
	{
		...
		price: '$2.99',
		period: '/month',
		description: 'Unlock the full lo-fi experience',
		features: [
			'20+ radio stations across 7 genres',
			'All 12 audio effects',
			'All 20+ presets + custom saves',
			'Tab audio mode (any browser tab)',
			'All 16 themes',
			'Unlimited favorites',
			'Keyboard shortcuts',
			'Custom station URLs',
	...
	},
	{
		...
		features: ['Everything in Premium', 'Save $11.88/year'],
		cta: 'Go Annual',
		highlighted: false,
	},
	{
		...
		price: '$49',
		period: 'one-time',
		description: 'Pay once, lo-fi forever',
		features: ['Everything in Premium', 'All future updates included', 'Never pay again'],
		cta: 'Get Lifetime',
		highlighted: false,
	},
] as const;
...
export const FAQ_ITEMS = [
	...
	},
	{
		...
		a: 'Yes. Monthly and annual subscriptions can be cancelled anytime. The lifetime plan is a one-time purchase with no recurring charges.',
	},
] as const;
